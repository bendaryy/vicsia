...
@section('content')
    ...
    <div class="wrapper" style="background-color: white">
        ...
        <div style="margin-bottom: 50px">
            <form method="POST" action="{{ route('storeInvoiceDollar') }}">
                @method("POST")
                @csrf
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-10 invoice-address-client">
                        ...
                        <div class="row">
                            ...
                            @if (request()->routeIs('createInvoiceDollar2'))
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addNewOne").click(function() {
                                     ...
                                     <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" step="any" type="number"
                                                                step="any" name="amountSold[]" id="amountSold${i}"
                                                                 onkeyup="DollarExchangeRate${i}(this.value);"
                                                                onmouseover="DollarExchangeRate${i}(this.value);"
                                                                >
                                                        ...
                                                        <div class="col-md-3">
                                                            <label for="linePrice"
                                                                class="form-label">سعر الدولار بالمصرى الان</label>
                                                            <input class="form-control" step="any" type="number"
                                                                step="any" name="currencyExchangeRate[]" id="currencyExchangeRate${i}"
                                                                onkeyup="DollarExchangeCurrency${i}(this.value);"
                                                                onmouseover="DollarExchangeCurrency${i}(this.value);">
                                                        </div>
                ...
                $('<script>  function DollarExchangeCurrency' + i +
                    '(value) {  var dollar = document.getElementById("amountSold' + i +
                    '").value;  var x = value * dollar; document.getElementById("amountEGP' + i +
                    '").value = x.toFixed(5);};  function DollarExchangeRate' + i +
                    '(value) { var dollar = document.getElementById("currencyExchangeRate' + i +
                    '").value; var x = value * dollar; document.getElementById("amountEGP' + i +
                    '").value = x.toFixed(5);}  function operation' +
                    i + '(value) {var x, y, z;  var quantity = document.getElementById("quantity' + i +
