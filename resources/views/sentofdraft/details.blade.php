                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered text-center">
                        ...
                        <tr>
                            ...
                            @isset($allSent['taxTotals'])
                                <td>
                                    @foreach ($allSent[0]['jsondata']['documents'][0]['taxTotals'] as $taxes)
                                        @if ($taxes[0]['jsondata']['documents'][0]['taxType'] == 'T4')
                                            الخصم تحت حساب الضريبة
                                        @elseif($taxes[0]['jsondata']['documents'][0]['taxType'] == 'T1')
                                            ضريبة القيمة المضافة
                                        @elseif ($taxes[0]['jsondata']['documents'][0]['taxType'] == 'T2')
                                            ضريبة الجدول (النسبية)
                                        @endif = {{ $taxes[0]['jsondata']['documents'][0]['amount'] }}
                                        <hr>
                                    @endforeach
                                </td>
                            @else
